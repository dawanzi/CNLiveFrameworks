...
#define KCopyLabelBgColor   [UIColor qmui_colorWithHexString:@"4bd647"]//RGB(216, 136, 0)
#define KGreenColor         @"00c200"
 ...
 *  UIColor
 */
#define ZXColorA(r ,g ,b ,a) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:(a)/255.0]
#define ZXColor(r ,g ,b) ZXColorA((r),(g),(b),255)
